  ...
  <nav class="shadow navbar navbar-inverse navbar-fixed-top nbar">
   ...
   <div class="collapse navbar-collapse navbar-menubuilder">
    <ul class="nav navbar-nav">
      <li class="space"><a href="compiler.php"><i class="fa fa-code ispace"></i>BCA Department</a></li>
      <li class="space"><a href="archive.php"><i class="fa fa-archive ispace"></i></a></li>
      <li class="space"><a href="contest.php"><i class="fa fa-cogs ispace"></i></a></li>
      <li class="space"><a href="#"><i class="fa fa-check-square ispace"></i></a></li>
